...
<body>
    ...
    <div class="navbar-expand-md navbar-dark fixed-top" style="background-color:#fdb515;">
        <div class="container">
            <div class="row">
                <div class="col-md-1 col-2 __logo-div" style="padding:0px;">
                    <img style="height:60px;" class="img-fluid" src="{{ asset('images/logo.png') }}">
                </div>

                <div class="col-md-6 col-10 __location-div">
                    <div class="row" style="margin-top:1em;">
                        <div class="col-md-6 col-6 catagory-text">
                            <div class="row ___location-div" style="background:#fff;display: flex;align-items: center;">
                                <div class="col-md-2 col-2 lol-in">
                                    <i style="font-size:18px;float:right;padding-top:5px;" class="fa fa-map-marker"
                                        aria-hidden="true"></i>
                                </div>
                            
                                <div class="col-md-12 col-12 __for-location" style="padding-left:0px;padding-top: 3px;padding-bottom: 1px; width: 100%;">
                                     <form method="get" action="" style="width:80%;">
                        ...
                        <div class="col-md-6 col-6">
                            <div class="row">
                                <div class="col-md-10 col-10 __for-input" style="padding-right:0px;">
                                    <input style="width:100%;border-radius:2px;padding-top: 3px;padding-bottom: 3px;" type="text" placeholder=" Search.." class="search">
                                </div>
                                <div class="col-md-2 col-2 __fa-search"
                                    style="background-color:#fbd515;padding-left:0px;">
                        
               <button type="button"  class="btn" onclick="search()"><i style="font-size:18px;float:left;" class="fa fa-search"></i></button>
                    </div>
                    </form>
                ...
                <div class="col-md-4 col-9 __form-div">
                    <div class="row __form-div-row" style="margin-top:20px">
                        <div class="col-md-6 col-6">
                            <div class="row" style="border-bottom:1px solid black;padding:0px;margin-left:0px;margin-right:0px;">
                                <div class="col-md-2 col-2" style="padding-left:5px;padding-right:0px;">
                                    <i class="fa fa-user-circle-o" style="font-size:18px;color:black;margin:0px;"></i>
                                </div>
                        ...
                        <div class="col-md-6 col-6">
                            <div class="row"
                                ...
                                <div class="col-md-2 col-2" style="padding-left:5px;padding-right:0px;">
                                    <i class="fa fa-lock" style="font-size:18px;color:black;margin:0px;"></i>
                                </div>
                ...
                <div class="col-md-1 col-2 __button-div" style="padding:0px;margin-top:1em;">
    ...
    <div class="container-fluid tab-container mobile-container jumbotron for-navbar-nav"
        style="padding:0px;margin-top:60px;background-color:#b3b3b3">
        <div class="container">
