...
<strong>{{ session()->get('warn') }}</strong> 
            ...
            <a href="{{ route('permission.create')  }}"><button type="button" class="btn btn-success btn-md"  style="float:right">Add permission
                </button></a>
                </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><h4>List of permission</h4> </strong>
                        </div>
                        <div class="card-body">
                    ...
                    @foreach($permissions as $permission)
                      <tr>
                       ...
                       <td>{{ $permission->name }}</td>
                        ...
                        <a href="{{ route('permission.edit',$permission->id) }}" data-toggle="tooltip" title="Edit"><button type="button" class="btn btn-success"><i class="fas fa-edit"></i>
                             edit </button></a>
                              
                              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal" onclick="handleDelete({{ $permission->id }})">
                                 Delete
                                  </button>  
