...
<strong>{{ session()->get('warn') }}</strong> 
            ...
            <a href="{{ route('location.create')  }}" ><button type="button" class="btn btn-success btn-md"  style="float:right">Add Location
                </button></a>
                </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><h4>List of Locations data</h4></strong>
                        </div>
                        <div class="card-body">
                    ...
                    @foreach($locations as $location)
                      <tr>
                       ...
                       <td>{{ $location->place_name }}</td>
                        ...
                        <a href="{{ route('location.edit',$location->id) }}" data-toggle="tooltip" title="Edit"><button type="button" class="btn btn-success">
                             edit </button></a>
                              


                             <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal" onclick="handleDelete({{ $location->id }})">
                                 Delete
                                  </button>
