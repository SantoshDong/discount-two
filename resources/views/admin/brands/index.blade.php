...
<strong>{{ session()->get('warn') }}</strong> 
            ...
            <a href="{{ route('brand.create') }}" ><button type="button" class="btn btn-success btn-md"  style="float:right">Add Brand
                </button></a>
                </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><h4>List of Brand's data</h4></strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    @foreach($brands as $brand)
                      <tr> 
                  <td>{{ $i++ }}</td> 
                       <td><img src="/storage/{{ $brand->brand_logo }}" height="50px" width="50p"></td>
                        <td>
                        <a href="{{ route('brand.edit',$brand->id) }}" data-toggle="tooltip" title="Edit"><button type="button" class="btn btn-success">
                             edit </button></a>
                             <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal" onclick="handleDelete({{ $brand->id }})">
                                 Delete
                                  </button>
                        </td>   
                </tr>
