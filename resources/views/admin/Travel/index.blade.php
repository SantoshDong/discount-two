...
<strong>{{ session()->get('warn') }}</strong> 
            ...
            <a href="{{ route('travel.create')  }}" ><button type="button" class="btn btn-success btn-md"  style="float:right">Add Travel
                </button></a>
                </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><h4>List oftravel's data</h4> </strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    @foreach($travels as $travel)
                      <tr>
                       ...
                       <td>{{ $travel->title }}</td>
                        <td><img src="/storage/{{ $travel->logo }}" height="50px" width="50px"></td>
                      
                        <td>
                        <a href="{{ route('travel.edit',$travel->id) }}" data-toggle="tooltip" title="Edit"><button type="button" class="btn btn-success"><i class="fas fa-edit"></i>
                             edit </button></a>
                              
                              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal" onclick="handleDelete({{ $travel->id }})">
                                 Delete
                                  </button>  
